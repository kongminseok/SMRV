...
if __name__ == '__main__':
    ...
    # Load a pre-trained Keras model, convert it to TensorFlow Lite format with optional quantization, and optionally generate an OpenVINO CLI command for further conversion.
